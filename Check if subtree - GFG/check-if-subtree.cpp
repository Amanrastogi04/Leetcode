  ...
  public:
    ...
    bool match(Node* root, Node* sroot){
        if(root!=NULL && sroot!=NULL){
            bool a=match(root->left,sroot->left);
            bool b=match(root->right,sroot->right);
    ...
    void inorder(Node* root, Node* sroot){
        if(root!=NULL){
        
        inorder(root->left,sroot);
        
        bool x=match(root,sroot);
        if(x){
            ans=true;
        }
        
        inorder(root->right,sroot);
        }
    }
